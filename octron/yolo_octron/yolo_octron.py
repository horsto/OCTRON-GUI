...
class YOLO_octron:
    ...
    def train(self, 
        ...
        def _find_train_image_size(data_path): 
            ...
            -------
            height : float
                Average height of up to 5 randomly sampled images
            width : float
                Average width of up to 5 randomly sampled images
            rect : bool
            ...
            # Pick up to 5 random images to determine size
            num_images = min(5, len(png_files))
