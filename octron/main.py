...
class octron_widget(QWidget):
    ...
    def setupUi(self):
        ...
        icon1 = QIcon(u"qt_gui/icons/noun-project-7158867.svg")
        ...
        icon2 = QIcon(u"qt_gui/icons/noun-copywriting-7158879.svg")
        ...
        icon3 = QIcon(u"qt_gui/icons/noun-rocket-7158872.svg")
        ...
        icon4 = QIcon(u"qt_gui/icons/noun-conversion-7158876.svgw")
