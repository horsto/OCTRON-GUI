...
class octron_gui_elements(QWidget):
    ...
    def setupUi(self, base_path):
        ...
        self.octron.setMaximumSize(QSize(410, 800))
        ...
        self.octron.verticalLayoutWidget.setGeometry(QRect(0, 0, 412, 651))
        ...
        self.octron.octron_logo.setMinimumSize(QSize(410, 100))
        ...
        self.octron.mainLayout.addWidget(self.octron.octron_logo, 0, Qt.AlignmentFlag.AlignLeft)
        ...
        self.octron.toolBox.setMinimumSize(QSize(0, 0))
        self.octron.toolBox.setMaximumSize(QSize(410, 750))
        ...
        self.octron.project_tab.setGeometry(QRect(0, 0, 410, 387))
        ...
        self.octron.annotate_tab.setGeometry(QRect(0, 0, 405, 387))
        ...
        self.octron.train_tab.setGeometry(QRect(0, 0, 410, 387))
        ...
        self.octron.predict_tab.setGeometry(QRect(0, 0, 410, 387))
        ...
        self.octron.toolBox.setCurrentIndex(1)
