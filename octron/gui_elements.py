...
class octron_gui_elements(QWidget):
    ...
    def setupUi(self, base_path):
        ...
        self.octron.verticalLayoutWidget_4.setGeometry(QRect(0, 0, 402, 345))
        ...
        self.octron.widget = QWidget(self.octron.train_generate_groupbox)
        self.octron.widget.setObjectName(u"widget")
        self.octron.widget.setGeometry(QRect(10, 30, 281, 29))
        self.octron.train_progress_A_horizontalLayout = QHBoxLayout(self.octron.widget)
        ...
        self.octron.train_polygons_overall_progressbar = QProgressBar(self.octron.widget)
        ...
        self.octron.train_polygons_frames_progressbar = QProgressBar(self.octron.widget)
        ...
        self.octron.train_polygons_label = QLabel(self.octron.widget)
        ...
        self.octron.layoutWidget.setGeometry(QRect(10, 60, 281, 29))
        self.octron.train_progress_B_horizontalLayout = QHBoxLayout(self.octron.layoutWidget)
        ...
        self.octron.train_export_overall_progressbar = QProgressBar(self.octron.layoutWidget)
        ...
        self.octron.train_export_frames_progressbar = QProgressBar(self.octron.layoutWidget)
        ...
        self.octron.train_export_label = QLabel(self.octron.layoutWidget)
        ...
        self.octron.widget1 = QWidget(self.octron.train_generate_groupbox)
        self.octron.widget1.setObjectName(u"widget1")
        self.octron.widget1.setGeometry(QRect(300, 30, 90, 51))
        self.octron.train_checkboxes_verticalLayout = QVBoxLayout(self.octron.widget1)
        ...
        self.octron.train_prune_checkBox = QCheckBox(self.octron.widget1)
        ...
        self.octron.train_data_overwrite_checkBox = QCheckBox(self.octron.widget1)
        ...
        self.octron.widget2 = QWidget(self.octron.train_generate_groupbox)
        self.octron.widget2.setObjectName(u"widget2")
        self.octron.widget2.setGeometry(QRect(10, 90, 381, 37))
        self.octron.train_folder_btn_horizontalLayout = QHBoxLayout(self.octron.widget2)
        ...
        self.octron.training_data_folder_label = QLabel(self.octron.widget2)
        ...
        self.octron.widget3 = QWidget(self.octron.train_train_groupbox)
        self.octron.widget3.setObjectName(u"widget3")
        self.octron.widget3.setGeometry(QRect(10, 70, 191, 62))
        self.octron.train_grid_layout = QGridLayout(self.octron.widget3)
        self.octron.train_grid_layout.setObjectName(u"train_grid_layout")
        self.octron.train_grid_layout.setContentsMargins(0, 0, 10, 0)
        self.octron.num_epochs_label = QLabel(self.octron.widget3)
        ...
        self.octron.save_period_label = QLabel(self.octron.widget3)
        ...
        self.octron.num_epochs_input = QSpinBox(self.octron.widget3)
        ...
        self.octron.save_period_input = QSpinBox(self.octron.widget3)
        ...
        self.octron.widget4.setGeometry(QRect(300, 30, 91, 101))
        ...
        self.octron.train_resume_checkBox = QCheckBox(self.octron.widget4)
        ...
        self.octron.train_training_overwrite_checkBox = QCheckBox(self.octron.widget4)
        ...
        self.octron.yolomodel_list = QComboBox(self.octron.widget5)
        ...
        self.octron.yoloimagesize_list = QComboBox(self.octron.widget5)
        ...
        self.octron.widget6.setGeometry(QRect(10, 140, 381, 29))
        ...
        self.octron.train_epochs_progressbar = QProgressBar(self.octron.widget6)
        ...
        self.octron.train_epochs_progressbar.setMinimumSize(QSize(200, 25))
        self.octron.train_epochs_progressbar.setMaximumSize(QSize(200, 25))
        ...
        self.octron.train_finishtime_label = QLabel(self.octron.widget6)
