...
class octron_gui_elements(QWidget):
    ...
    def setupUi(self, base_path):
        ...
        self.octron.verticalLayoutWidget_2.setGeometry(QRect(0, 0, 402, 411))
        ...
        self.octron.annotate_vertical_layout.addWidget(self.octron.annotate_param_groupbox, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
        ...
        sizePolicy3.setHeightForWidth(self.octron.annotate_layer_save_groupbox.sizePolicy().hasHeightForWidth())
        self.octron.annotate_layer_save_groupbox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.octron.batch_save_progressbar.sizePolicy().hasHeightForWidth())
        self.octron.batch_save_progressbar.setSizePolicy(sizePolicy5)
