...
class Ui_octron_widgetui(object):
    def setupUi(self, octron_widgetui):
        ...
        self.folder_sect_groupbox.setMinimumSize(QSize(400, 50))
        self.folder_sect_groupbox.setMaximumSize(QSize(400, 50))
    ...
    def retranslateUi(self, octron_widgetui):
        ...
        self.create_project_btn.setText(QCoreApplication.translate("octron_widgetui", u"\u2295 Create octron project", None))
