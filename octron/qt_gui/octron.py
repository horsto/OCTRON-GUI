...
class Ui_octron_widgetui(object):
    def setupUi(self, octron_widgetui):
        ...
        self.prediction_mask_opening_label = QLabel(self.layoutWidget9)
        self.prediction_mask_opening_label.setObjectName(u"prediction_mask_opening_label")
        sizePolicy5.setHeightForWidth(self.prediction_mask_opening_label.sizePolicy().hasHeightForWidth())
        self.prediction_mask_opening_label.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout_3.addWidget(self.prediction_mask_opening_label, 0, 0, 1, 1, Qt.AlignmentFlag.AlignLeft)

        self.predict_mask_opening_spinbox = QDoubleSpinBox(self.layoutWidget9)
...
#if QT_CONFIG(tooltip)
        self.prediction_mask_opening_label.setToolTip(QCoreApplication.translate("octron_widgetui", u"Morphological opening of predicted masks.\n"
