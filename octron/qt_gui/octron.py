...
class Ui_octron_widgetui(object):
    def setupUi(self, octron_widgetui):
        ...
        octron_widgetui.setMinimumSize(QSize(410, 600))
        octron_widgetui.setMaximumSize(QSize(410, 600))
        ...
        self.toolBox.setMinimumSize(QSize(410, 450))
        self.toolBox.setMaximumSize(QSize(410, 450))
        ...
        self.create_project_btn.setMinimumSize(QSize(250, 25))
        self.create_project_btn.setMaximumSize(QSize(300, 25))

        self.horizontalLayout_11.addWidget(self.create_project_btn, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignVCenter)
        ...
        self.annotate_tab.setGeometry(QRect(0, 0, 405, 314))
        ...
        self.predict_tab.setGeometry(QRect(0, 0, 98, 28))
    ...
    def retranslateUi(self, octron_widgetui):
        ...
        self.create_project_btn.setText(QCoreApplication.translate("octron_widgetui", u"\u2295 Choose folder", None))
