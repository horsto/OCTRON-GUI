...
class Ui_octron_widgetui(object):
    def setupUi(self, octron_widgetui):
        ...
        self.verticalLayoutWidget_2.setGeometry(QRect(0, 0, 402, 411))
        ...
        self.annotate_vertical_layout.addWidget(self.annotate_param_groupbox, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
        ...
        sizePolicy3.setHeightForWidth(self.annotate_layer_save_groupbox.sizePolicy().hasHeightForWidth())
        self.annotate_layer_save_groupbox.setSizePolicy(sizePolicy3)
        ...
        sizePolicy5.setHeightForWidth(self.batch_save_progressbar.sizePolicy().hasHeightForWidth())
        self.batch_save_progressbar.setSizePolicy(sizePolicy5)
        ...
        self.mainLayout.addWidget(self.toolBox, 0, Qt.AlignmentFlag.AlignHCenter|Qt.AlignmentFlag.AlignTop)
