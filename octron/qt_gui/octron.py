...
class Ui_octron_widgetui(object):
    def setupUi(self, octron_widgetui):
        ...
        self.yolomodel_list.setMinimumSize(QSize(160, 25))
        self.yolomodel_list.setMaximumSize(QSize(160, 25))
        ...
        self.verticalLayoutWidget_5.setGeometry(QRect(0, 0, 402, 150))
        ...
        self.predict_verticalLayout.setContentsMargins(0, 0, 0, 0)
...
"labels is present.", None))
        ...
        self.training_data_folder_label.setText(QCoreApplication.translate("octron_widgetui", u"Folder", None))
