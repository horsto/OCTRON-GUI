...
"and octo and suffix 2 for the second octo ", None))
...
#endif // QT_CONFIG(tooltip)
        self.hard_reset_layer_btn.setText(QCoreApplication.translate("octron_widgetui", u"\u26a0\ufe0fReset", None))
#if QT_CONFIG(tooltip)
        ...
        self.create_projection_layer_btn.setText(QCoreApplication.translate("octron_widgetui", u"Create projection", None))
