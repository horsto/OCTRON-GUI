...
class Ui_octron_widgetui(object):
    def setupUi(self, octron_widgetui):
        ...
        octron_widgetui.resize(410, 600)
    ...
    def retranslateUi(self, octron_widgetui):
        ...
        self.layer_type_combobox.setItemText(2, QCoreApplication.translate("octron_widgetui", u"Point->Mask Layer", None))
        self.layer_type_combobox.setItemText(3, QCoreApplication.translate("octron_widgetui", u"Anchor point Layer ", None))

        self.layer_type_combobox.setCurrentText(QCoreApplication.translate("octron_widgetui", u"Layer Type", None))
        self.label_name_lineedit.setPlaceholderText(QCoreApplication.translate("octron_widgetui", u"Label name", None))
        ...
        self.predict_next_batch_btn.setText(QCoreApplication.translate("octron_widgetui", u"Predict next 20 frames", None))
