<img src="octron/qt_gui/octron_logo_website.svg" alt="OCTRON Logo" width="90%" style="display: block; margin-left: auto; margin-right: auto; margin-top: -2rem; margin-bottom: 1rem;" />
